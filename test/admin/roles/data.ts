...
export const mockRolesData: Role[] = [
  ...
  },
  {
    ...
    description: 'Tenant Administrator\nFull resource management permissions within tenant (manage)',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Executive Director / Facility Director\nBusiness data management, cards read-only, no iot_timeseries permission',
    is_system: true,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    role_code: 'Nurse',
    display_name: 'Nurse',
    description: 'Nurse\nView all, manage assigned residents (assigned_only), can update emergency contacts',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Caregiver\nOnly view and record assigned residents',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Resident\nwellness&safely monitor, configure emerge contact',
    is_system: true,
    is_active: true,
  },
  {
