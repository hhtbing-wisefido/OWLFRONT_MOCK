...
export const mockRolesData: Role[] = [
  {
    ...
    description: 'Manage system-level resources (roles, role_permissions, device_store, tenants, tags_catalog), business data read-only',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Full resource management permissions within tenant (manage)',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Business data management, cards read-only, no iot_timeseries permission',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Device management, Layout management, user account management, device configuration',
    is_system: true,
    is_active: true,
  },
  {
    ...
    role_code: 'Nurse',
    display_name: 'Nurse',
    description: 'View all, manage assigned residents (assigned_only), can update emergency contacts',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Only view and record assigned residents',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'wellness&safely monitor, configure emerge contact',
    is_system: true,
    is_active: true,
  },
  {
