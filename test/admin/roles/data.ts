...
export const mockRolesData: Role[] = [
  {
    ...
    description: 'System Administrator (Cross-Tenant)\nManage system-level resources (roles, role_permissions, device_store, tenants, tags_catalog). Business data read-only.',
    is_system: true,
    is_active: true,
  },
  {
    ...
    description: 'Administrator\nFull resource management permissions within tenant.',
    is_system: true,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    description: 'IT Support\nDevice management, Layout management, user account management, device configuration.',
    is_system: true,
    is_active: true,
  },
  {
    ...
    role_code: 'Nurse',
    display_name: 'Nurse',
    description: 'Nurse\nView assigned residents monitor, handle alarm event, set special alarm.',
    is_system: true,
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    description: 'Resident\nView self wellness & safety, authorize emergency contact, special environment: handle self alarm event.',
    is_system: true,
    is_active: true,
  },
  {
    ...
    role_code: 'Family',
    display_name: 'Family',
    description: 'Family\nView family member\'s wellness & safety info, alarm info, special environment: handle alarm event.',
    is_system: true,
    is_active: true,
  },
]
