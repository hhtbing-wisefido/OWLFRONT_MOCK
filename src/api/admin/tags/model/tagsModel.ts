...
/**
 * Add objects to Tag request parameters
 */
export interface AddTagObjectsParams {
  tag_id: string
  object_type: string // Object type: 'resident', 'location', 'user', 'card', 'caregiver_group', 'branch', 'area'
  objects: Array<{ object_id: string; object_name: string }> // List of objects to add
}
