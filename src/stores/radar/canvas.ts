...
import type { CanvasParams } from '@/utils/radar/types';
...
export const useCanvasStore = defineStore('canvas', {
  ...
  actions: {
    ...
    setDrawingMode(mode: string | null) {
      ...
      console.log(mode ? `✏️ Enter drawing mode: ${mode}` : '🖱️ Exit drawing mode');
    },
    ...
    setPendingObjectType(type: string | null) {
      ...
      console.log(type ? `🏗️ Pending object: ${type}` : 'Clear pending object');
    },
    ...
    setParams(params: CanvasParams) {
      this.params = params;
      console.log('📋 Canvas parameters set:', params);
    },
