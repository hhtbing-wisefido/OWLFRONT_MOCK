...
export const useWaveformStore = defineStore('waveform', {
  ...
  actions: {
    ...
    togglePause() {
      ...
      console.log(this.isPaused ? '⏸️ Waveform paused' : '▶️ Waveform resumed');
    },
    ...
    clearAll() {
      ...
      this.lastUpdate = 0;
      console.log('🧹 Waveform data cleared');
    },
    ...
    mockData() {
      ...
      // 模拟睡眠状态
      this.updateCurrentValue('sleepState', 'Light Sleep');
